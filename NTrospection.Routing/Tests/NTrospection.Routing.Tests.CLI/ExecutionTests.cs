...
namespace NTrospection.Routing.Tests.CLI
{
    ...
    public class ExecutionTests
    {
        ...
        private const string _executableName = "NTrospection.Routing.CLI.TestApp.exe";

        [TestInitialize]
        public void Setup()
        {
            _directory = Directory.GetParent((new System.Uri(Assembly.GetExecutingAssembly().CodeBase)).AbsolutePath).Parent.Parent.Parent.Parent.FullName + @"\NTrospection.Routing.CLI.TestApp\bin\Debug\netcoreapp2.2\win10-x64\";
        }
